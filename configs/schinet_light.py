...
chi_params = {
	'st': {'enc_kernel_sizes': ((1, 7, 7), (21, 35, 35)), 'enc_strides': ((1, 2, 2), (8, 16, 16)), 'enc_channels': (8, 64), 'fmap_size': (8, 4), 'shrink_min_dim': True, 'token_dim': (2, 3, 4), 'x_dim': ('s', 't'), 'alternate_attn': False, 'convattn': True},
	'sc': {'enc_kernel_sizes': ((21, 7, 7), (1, 35, 35)), 'enc_strides': ((8, 2, 2), (1, 16, 16)), 'enc_channels': (64, 8), 'fmap_size': (8, 4), 'shrink_min_dim': True, 'token_dim': (2, 3, 4), 'x_dim': ('s', 'c'), 'alternate_attn': False, 'convattn': True},
	'tc': {'enc_kernel_sizes': ((1, 35, 35), (21, 7, 7)), 'enc_strides': ((1, 16, 16), (8, 2, 2)), 'enc_channels': (64, 8), 'fmap_size': (8, 4), 'shrink_min_dim': True, 'token_dim': (2, 3, 4), 'x_dim': ('t', 'c'), 'alternate_attn': False, 'convattn': True},
}
...
for d, p, lr, chi_mode in [(d, p, lr, chi_mode) for d in datasets for p in precisions for lr in lrs for chi_mode in chi_params]:
	schinet[chi_mode + '_' + p + '_' + lr + '_' + d] = {
		**data_defaults_large_clip[d],
		'model': 'models.SChiNet_light.SChiNet',
		**chi_params[chi_mode],
