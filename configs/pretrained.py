schinet = {
        ...
        'frames_per_clip': 64, 'space_between_frames': 2, 'min_space_between_frames': None, 'max_space_between_frames': None,
        ...
        'eval_clip_len': 64, 'eval_clip_location': 'center', 'eval_clip_step': 1, 'eval_auto_len': None,
        ...
        'batch_size': 32, 'eval_batch_size': 32, 'lr': 1e-3, 'wdecay': 5e-5,
...
ca3d = {
        ...
        'batch_size': 20, 'eval_batch_size': 20, 'lr': 1e-3, 'wdecay': 5e-5,
...
vivit = {
        ...
        'auto_len': None, 'min_auto_len': None, 'max_auto_len': None, 'data_backend': 'default',
        'eval_clip_len': 32, 'eval_clip_location': 'center', 'eval_clip_step': 1, 'eval_auto_len': None,
		'preproc_clip_len': 16, 'preproc_clip_location': 'center', 'preproc_clip_step': 1, 'preproc_auto_len': None,
        'model': 'models.hub.PreTrainedViViT.PreTrainedViViT',
        'precision': 'float32', 'qat': False, 'stretch': (1, 1, 1),
        'batch_size': 4, 'eval_batch_size': 4, 'lr': 1e-3, 'wdecay': 5e-5,
        'epochs': 50, 'sched_decay': 0.5, 'sched_milestones': range(25, 50, 5),
        #'epochs': 100, 'sched_decay': 0.1, 'sched_milestones': [40, 70, 90],
}
